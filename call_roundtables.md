---
title: "Call for Roundtables"
category: "Register and Submit your Proposal"
description: ""
layout: project/featured_image
custom_color: green
custom_font: urbanist
thumbnail: "/assets/img/illustrations/8592637.jpg"
hero_image: "/assets/img/illustrations/8592637.jpg"
about_title: ""

# Additional content block appears after gallery
additional_content: |
  <a href="https://www.ishs2026.eventos.dype.com.br"><button type="button" style="background-color: #45c4a0; color: white; padding: 10px 20px; border: none; border-radius: 50rem !important; cursor: pointer;"><strong>REGISTER NOW</strong></button></a>

---

The ISHS welcomes also roundtables from the numerous expertises, such as social sciences, communication and media studies, anthropology, political science, history, psychology, education, linguistics and translation, folklore, computational sciences and engineering, robotics, law, among others. 

The roundtables can be proposed both by individuals and by the local organizing committee in specific cases to promote development on certain topics.
...
* Title and brief description (one to two short lines) about the interests covered by the roundtable.

* List of respective authors and their mini-bios. All authors must have agreed to compose the roundtable. Authors must also register to the conference separately. 
